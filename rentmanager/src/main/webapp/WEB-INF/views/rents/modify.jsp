                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="box-body">
                                            ...
                                            <c:forEach items="${allVehicles}" var="vehicle">
                                                <c:choose>
                                                    <c:when test="${vehicle.id == reservation.vehicle.id}">
                                                        <option value="${vehicle.id}" selected>${vehicle.constructor} ${vehicle.modele}</option>
                                                    </c:when>
                                                    <c:otherwise>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="beginning" name="beginning" value=${reservation.beginning}>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="ending" class="col-sm-2 control-label">Fin</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" id="ending" name="ending" value=${reservation.ending}>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
